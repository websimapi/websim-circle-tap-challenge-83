...
const Visualizer = ({ pulseAmount, targetColor, radius, lineWidth, customPath }) => {
  ...
  if (customPath) {
    return /* @__PURE__ */ jsxDEV("g", { style: { mixBlendMode: "plus-lighter" }, children: [
      /* @__PURE__ */ jsxDEV(
        "path",
        {
          d: customPath,
          stroke: baseColor,
          strokeWidth: lineWidth * (3 + pulseAmount * 4),
          fill: "none",
          strokeLinecap: "round",
          strokeLinejoin: "round",
          style: {
            opacity: 0.15 * pulseAmount
          }
        },
        void 0,
        false,
      ...
      /* @__PURE__ */ jsxDEV(
        "path",
        {
          d: customPath,
          stroke: baseColor,
          strokeWidth: lineWidth * (1.5 + pulseAmount * 2),
          fill: "none",
          strokeLinecap: "round",
          strokeLinejoin: "round",
          style: {
            opacity: 0.3 * pulseAmount
          }
        },
        void 0,
        false,
      ...
      /* @__PURE__ */ jsxDEV(
        "path",
        {
          d: customPath,
          stroke: baseColor,
          strokeWidth: lineWidth * (0.8 + pulseAmount * 0.5),
          fill: "none",
          strokeLinecap: "round",
          strokeLinejoin: "round",
          style: {
            opacity: 0.6 + 0.3 * pulseAmount
          }
        },
        void 0,
        false,
  ...
  const pulseExtentInner = Math.max(0, innerRadius * (1 - pulseAmount * 0.4));
  ...
  return /* @__PURE__ */ jsxDEV("g", { style: { mixBlendMode: "screen" }, children: [
    /* @__PURE__ */ jsxDEV("defs", { children: [
      ...
      /* @__PURE__ */ jsxDEV("radialGradient", { id: gradInnerId, cx: "0", cy: "0", r: innerRadius, gradientUnits: "userSpaceOnUse", children: [
        ...
        /* @__PURE__ */ jsxDEV("stop", { offset: `${pulseExtentInner / innerRadius + 0.2}`, stopColor: "rgba(0,0,0,0)" }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 91,
          columnNumber: 22
        }),
        /* @__PURE__ */ jsxDEV("stop", { offset: `${pulseExtentInner / innerRadius + 0.5}`, stopColor: getTransparentColor(pulseAmount * 0.05) }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 92,
          columnNumber: 22
        }),
...
const GameCanvas = ({ frameData, config }) => {
  ...
  const radius = 45;
  const lineWidth = radius / 0.35 * trackWidthFactor;

...
export class Game {
    ...
    reset() {
        ...
        // If custom mode, ensure we keep the map data unless specifically cleared
        if (this.mode === 'custom' && this.customMapData) {
            this.renderer.setCustomMap(this.customMapData.points);
        }
